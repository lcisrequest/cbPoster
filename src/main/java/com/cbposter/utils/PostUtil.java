...
public class PostUtil {
    ...
    static String BOUNDARY = java.util.UUID.randomUUID().toString(); // 分隔符
    static String PREFIX = "--";
    static String LINE_END = "\r\n"; // 分隔符
    static String MULTIPART_FROM_DATA = "multipart/form-data"; // form提交
     ...
     * @Description:
     */
    public static String sendPost3(String requestUrl,
